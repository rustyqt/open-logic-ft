...
-- Description
---------------------------------------------------------------------------------------------------
-- Clock crossing for resets, with TMR-hardened CDC synchronizers. This entity is structurally
-- identical to olo_base_cc_reset but instantiates olo_ft_cc_bits (triplicated, TMR) instead of
...
-- synchronously to the corresponding clock. Reset is clock-crossed in both directions.
--
-- Documentation:
-- https://github.com/open-logic/open-logic/blob/main/doc/ft/olo_ft_cc_reset.md
--
...
-- Architecture
---------------------------------------------------------------------------------------------------
architecture struct of olo_ft_cc_reset is
...
begin
    ...
    -- Ack Crossing (TMR-hardened via olo_ft_cc_bits)
    i_ackb2a : entity work.olo_ft_cc_bits
        generic map (
            Width_g      => 1,
    ...
    i_acka2b : entity work.olo_ft_cc_bits
        generic map (
            Width_g      => 1,
            SyncStages_g => SyncStages_g
        )
